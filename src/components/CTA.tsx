          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-5">
              <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-7 backdrop-blur">
                ...
                <a
                  href={`tel:+351${COMPANY.phone.replace(/\s/g, "")}`}
                  className="mt-3 inline-flex items-center gap-2 font-display text-2xl sm:text-4xl font-bold hover:text-gold-400 transition-colors"
                  aria-label={`Ligar para ${COMPANY.phone}`}
                >
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" className="h-5 w-5 sm:h-6 sm:w-6 text-gold-400" aria-hidden>
